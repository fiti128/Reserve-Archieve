REM Программа резервного копирования АС "Бухгалтерский учет капитальных вложений"
...
goto exit
 ...
 :success
echo УСПЕХ --- %date% %time% : Задача резервного копирования АС "Бухгалтерский учет капитальных вложений УСПЕШНО! >> %log_file%
